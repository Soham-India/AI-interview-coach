...
import { Rocket, Shield, History, Target, Zap, BookOpen, PlusCircle, Download } from "lucide-react";
const OBJECTIVE_ICONS = [Rocket, Shield, History, Target, Zap, BookOpen];

const TacticalObjectivesView = ({ recommendations = [], onNewInterview }) => {
      ...
      <div className="w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-frame border border-frame">
          {recommendations.map((rec, index) => {
            const IconComponent = OBJECTIVE_ICONS[index % OBJECTIVE_ICONS.length];
            return (
              <div 
                key={index}
